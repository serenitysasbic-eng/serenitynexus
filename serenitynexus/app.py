...
# Recuerda instalar: pip install folium streamlit-folium reportlab
import folium
...
def generar_pdf_certificado(nombre, monto):
    ...
    c.drawCentredString(4.25*inch, 6.0*inch, f"Destinado a la regeneración del KBA Bosque San Antonio c.y al Bienestar de la Comunidad Local")
...
st.markdown("""
    <style>
        ...
        /* ESTILO AEROLÍNEAS (BOTONES DE ENLACE) */
        .airline-grid { 
...
# 8. MAPAS
    ...
    st.title("📍 Ubicación Serenity (Dagua y Felidia Valle del Cauca  Colombia)")
