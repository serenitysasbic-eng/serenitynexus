...
def generar_pdf_corporativo(empresa, impacto, hash_id, nit="", logo_bytes=None, es_vademecum=False, faro_nombre="Red Nexus"):
    ...
    if es_vademecum:
        lineas = [
            ...
            "   Nuestra labor: Geolocalización individual y custodia en las áreas de vida.", "",
...
def footer():
    ...
    st.markdown(
        ...
        <div style='text-align: center; color: grey; font-size: 0.8em;'>
            <p>© 2026 <b>Serenity Nexus Global</b> - Todos los derechos reservados.</p>
    ...
    with st.expander("⚖️ Aviso Legal y Propiedad Intelectual"):
        ...
        la arquitectura 'Puntos Faro' o la marca Serenity Nexus Global será objeto 
